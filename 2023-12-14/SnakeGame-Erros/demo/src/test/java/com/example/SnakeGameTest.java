...
public class SnakeGameTest {
    ...
    public void testFoodPosition() {
        // A comida deve iniciar em uma posição aleatória, diferente da posição inicial
        // da cabeça da cobra.
    ...
    public void testGameInterval() {
        // O jogo deve ser atualizado em intervalos regulares, mantendo uma jogabilidade
        // suave.
    ...
    public void testRightMoving() {
        // A cabeça da cobra deve mover-se para a direita em relação à sua posição
        // inicial.

        snakeGame.keyPressed(
                new KeyEvent(snakeGame, KeyEvent.KEY_PRESSED, System.currentTimeMillis(), 0, KeyEvent.VK_RIGHT, 'D'));
    ...
    public void testLeftMoving() {
        // A cabeça da cobra deve mover-se para a esquerda em relação à sua posição
        // inicial.

        // snakeGame.directionX = 0;

        snakeGame.keyPressed(
                new KeyEvent(snakeGame, KeyEvent.KEY_PRESSED, System.currentTimeMillis(), 0, KeyEvent.VK_LEFT, 'A'));
    ...
    public void testUpMoving() {
        ...
        snakeGame.keyPressed(
                new KeyEvent(snakeGame, KeyEvent.KEY_PRESSED, System.currentTimeMillis(), 0, KeyEvent.VK_UP, 'W'));
    ...
    public void testDownMoving() {
        ...
        snakeGame.keyPressed(
                new KeyEvent(snakeGame, KeyEvent.KEY_PRESSED, System.currentTimeMillis(), 0, KeyEvent.VK_DOWN, 'S'));
    ...
    // @Test
    // public void testSnakeCollisionGameOver (){
    //     // O game over deve ocorrer quando a cobra colide com ela mesma
    ...
    //     snakeGame.movementAndCollision.collision(snakeGame.snakeHead, snakeGame.snakeBody.get(0));
